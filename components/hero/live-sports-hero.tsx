    ...
    switch (heroContent.type) {
      ...
      case "live_show":
        return {
          ...
          rightText: heroContent.description?.substring(0, 50) + "..." || "Live Now"
        }
      case "scheduled_game":
        return {
          bgColor: "bg-gray-600",
          ...
          <div className="absolute bottom-4 left-4 right-4 bg-black/50 backdrop-blur-sm rounded-lg p-4 border border-white/10 hidden">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Button size="sm" className="bg-white/20 hover:bg-white/30 p-2 rounded-full transition-colors">
                ...
                <span className="text-white text-sm font-medium">
                  {heroContent.type === "live_show" ? heroContent.showTitle : 
                   heroContent.type === "scheduled_game" ? `${heroContent.awayTeam} @ ${heroContent.homeTeam} - Upcoming` :
            ...
            <div className="mt-3">
              ...
              <div className="flex justify-between text-xs text-gray-300 mt-1">
                <span>
                  {heroContent.type === "live_show" ? "0:45:12" :
                   heroContent.type === "scheduled_game" ? "0:00:00" : "2:15:30"}
                </span>
                <span>
                  {heroContent.type === "live_show" ? "Live Show" :
                   heroContent.type === "scheduled_game" ? "Upcoming" : "Live"}
                </span>
              </div>
            </div>
          </div>
